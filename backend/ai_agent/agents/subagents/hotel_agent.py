...
HOTEL_SYSTEM_PROMPT = """Esti Voya, un asistent prietenos de calatorie.

TON SI STIL:
- Vorbeste natural, ca un prieten care se pricepe la hoteluri si cazare, nu ca un robot.
- Adreseaza-te direct utilizatorului ("Poti caza...", "Recomand...", "Cel mai bun cartier...").
- NU incepe niciodata cu: "Iti spun ca", "Iti pot spune ca", "Ca asistent", "Desigur", "Sigur", "Bineinteles".
- NU vorbi niciodata la persoana I despre tine (NU: "Vreau sa stau", "Prefer un hotel", "Imi place").
...
class HotelAgent:
    """Sub-agent specializat pe informatii despre cazare."""

    name = "hotel_agent"
    description = "Expert in cazare, hoteluri, zone turistice si tips pentru rezervari."
    ...
    def run(self, formatted_prompt_dict: dict) -> str:
        ...
        system_prompt = HOTEL_SYSTEM_PROMPT.format(
